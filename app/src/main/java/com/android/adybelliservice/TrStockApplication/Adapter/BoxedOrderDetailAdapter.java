...
public class BoxedOrderDetailAdapter extends RecyclerView.Adapter<BoxedOrderDetailAdapter.ViewHolder> {
    private ArrayList<OrderDetail> arrayList = new ArrayList<>();
    private Context context;
    private FragmentManager fragmentManager;
    private String old_box_id;
    public BoxedOrderDetailAdapter(ArrayList<OrderDetail> arrayList, Context context, FragmentManager childFragmentManager,String old_box_id) {
    ...
    private void show(OrderDetail item, ViewHolder holder, int absoluteAdapterPosition) {
        new BoxDialog2(item.getOd_id(),old_box_id).show(fragmentManager,BoxDialog.class.getSimpleName());
    }
